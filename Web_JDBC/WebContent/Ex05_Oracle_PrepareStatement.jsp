...
<%
	 ...
	 try{
		 ...
		 //만약 조건절이 세 개라면?
		 //where empno=? and deptno=? ans cal > ?
		 //이 때는
		 // pstmt.setInt(1, 788);
		 // pstmt.setInt(2, 30);
		 // pstmt.setInt(3, 1000);
		 ...
		 //stmt = conn.createStatement();
		  pstmt = conn.prepareStatement(sql); //명령객체 생성시 oracle에 쿼리 미리 보내서(Prepared) 컴파일		 
		 ...
		 //SingletonHelper.close(conn) 공유객체( singleton )라서 한쪽에서 닫으면 다 닫힌다! 어플리케이션 종료시에만!
	 }
%> 
<!DOCTYPE html>
<html>
